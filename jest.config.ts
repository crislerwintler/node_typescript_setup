...
export default {
  ...
  // cacheDirectory: "C:\\Users\\music\\AppData\\Local\\Temp\\jest",
  ...
  // coverageProviderinformation should be collected
  ...
  // tests.Can be specified as % or a number.E.g.maxWorkers: 10 % will use 10 % of
